...
const sidebar = () => {
  const isMobile = useMediaQuery({ query: "(max-width: 1089px)" });
  const router = useRouter();

  return (
    <div className={isMobile ? "sidebar collapse" : "sidebar"}>
      <span className="logo">S</span>
      <a className="logo-expand side-menu-item" href="#">
        skateboard
      </a>
      <div className="side-wrapper">
        <div className="side-title">
          <span className="side-menu-item">MENU</span>
        </div>
            ...
            <a
              className={
                router.pathname == "/home"
                  ? "sidebar-link discover is-active"
                  : "sidebar-link discover"
              }
            >
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M9.135 20.773v-3.057c0-.78.637-1.414 1.423-1.414h2.875c.377 0 .74.15 1.006.414.267.265.417.625.417 1v3.057c-.002.325.126.637.356.867.23.23.544.36.87.36h1.962a3.46 3.46 0 002.443-1 3.41 3.41 0 001.013-2.422V9.867c0-.735-.328-1.431-.895-1.902l-6.671-5.29a3.097 3.097 0 00-3.949.072L3.467 7.965A2.474 2.474 0 002.5 9.867v8.702C2.5 20.464 4.047 22 5.956 22h1.916c.68 0 1.231-.544 1.236-1.218l.027-.009z" />
              </svg>
              <span className="side-menu-item">Discover</span>
            </a>
          </Link>
          <Link href="/videos/">
            <a
              className={
                ...
                router.pathname == "/videos/[id]"
                  ? "sidebar-link trending is-active"
            ...
            >
              ...
              <span className="side-menu-item">Trending</span>
            </a>
          </Link>
          <Link href="#">
            <a className="sidebar-link">
              ...
              <span className="side-menu-item">Streaming</span>
            </a>
          </Link>
          <Link href="#">
            <a className="sidebar-link">
              ...
              <span className="side-menu-item">Playlist</span>
            </a>
          </Link>
          <Link href="#">
            <a className="sidebar-link">
              ...
              <span className="side-menu-item">Bookmark</span>
            </a>
          </Link>
        </div>
      </div>
      <div className="side-wrapper">
        <div className="side-title">
          <span className="side-menu-item">CATEGORY</span>
        </div>
        <div className="side-menu">
          <a className="sidebar-link" href="#">
            ...
            <span className="side-menu-item">Live Stream</span>
          </a>
          <a className="sidebar-link" href="#">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
            ...
            <span className="side-menu-item">Tutorial</span>
          </a>
          <a className="sidebar-link" href="#">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
            ...
            <span className="side-menu-item">Competation</span>
          </a>
          <a className="sidebar-link" href="#">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
            ...
            <span className="side-menu-item">Community</span>
          </a>
        </div>
      </div>
    </div>
